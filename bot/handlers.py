...
def get_menu() -> str:
    ...
    menu_text = "📝 *Lista de tipo de habitacion*\n\n"
...
async def start(update: Update, context: CallbackContext) -> None:
    await update.message.reply_text("¡Hola! Soy tu bot. ¿Cómo puedo ayudarte hoy? Puedes ver las HABITACIONES con el comando /menu o contactarnos con el comando /contact.")
...
async def contact(update: Update, context: CallbackContext) -> None:
    await update.message.reply_text("📧 Contáctanos en secretos.com.pe ¡Estamos aquí para ayudarte!")
